...
Do not use the standard C++ container classes. It is unfortunately common to use nested container classes such as \codei{std::vector<std::vector<data\_type>>}. Such constructs are inefficient and should be avoided.
\vspacesmall
